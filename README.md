...
- **Frontend** : Tailwind CSS 4.1 (CDN) + Vue.js 3
...
4. Créer la table de cache : `python manage.py createcachetable`
5. Collecter les fichiers statiques : `python manage.py collectstatic --noinput`
6. Configurer le serveur web pour servir `/media/` et `/static/`
